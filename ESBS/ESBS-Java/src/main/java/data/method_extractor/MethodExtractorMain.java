...
public class MethodExtractorMain {
    ...
    public void extractDefect4JMethods() throws IOException {
        ...
        CsvReader csvReader = CsvReader.builder().build(Paths.get("/home/ehsan/Workspace/java/ESBS/ESBS-Python/data/d4j_bugs.csv"));
        ...
        CsvWriter buggyMethodsCsvWriter = CsvWriter.builder().build(Paths.get("d4j_methods_buggy.csv"));
        CsvWriter nonBuggyMethodsCsvWriter = CsvWriter.builder().build(Paths.get("d4j_methods_nonbuggy.csv"));
        CsvWriter fixedMethodsCsvWriter = CsvWriter.builder().build(Paths.get("d4j_methods_fixed.csv"));

        buggyMethodsCsvWriter.writeRow("ProjectName", "ProjectVersion", "IssueTracker", "URL", "Priority", "ClassName", "StartLine", "EndLine", "SourceCode");
        nonBuggyMethodsCsvWriter.writeRow("ProjectName", "ProjectVersion", "IssueTracker", "URL", "Priority", "ClassName", "StartLine", "EndLine", "SourceCode");
        fixedMethodsCsvWriter.writeRow("ProjectName", "ProjectVersion", "IssueTracker", "URL", "Priority", "ClassName", "StartLine", "EndLine", "SourceCode");
    ...
    public void extractBugJarMethods() throws IOException {
        ...
        CsvReader csvReader = CsvReader.builder().build(Paths.get("/home/ehsan/Workspace/java/ESBS/ESBS-Python/data/bugs_jar_bugs.csv"));
        CloseableIterator<CsvRow> csvRow = csvReader.iterator();
        csvRow.next();
        ...
        CsvWriter buggyMethodsCsvWriter = CsvWriter.builder().build(Paths.get("bugsjar_methods_buggy.csv"));
        CsvWriter nonBuggyMethodsCsvWriter = CsvWriter.builder().build(Paths.get("bugsjar_methods_nonbuggy.csv"));
        CsvWriter fixedMethodsCsvWriter = CsvWriter.builder().build(Paths.get("bugsjar_methods_fixed.csv"));


        buggyMethodsCsvWriter.writeRow("ProjectName", "BranchName", "Priority", "ClassName", "StartLine", "EndLine", "SourceCode");
        nonBuggyMethodsCsvWriter.writeRow("ProjectName", "BranchName", "Priority", "ClassName", "StartLine", "EndLine", "SourceCode");
        fixedMethodsCsvWriter.writeRow("ProjectName", "ProjectVersion", "IssueTracker", "URL", "Priority", "ClassName", "StartLine", "EndLine", "SourceCode");
