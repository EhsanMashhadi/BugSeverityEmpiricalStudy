...
import metrics.halstead.HalsteadMain;
...
public class Halstead {
    ...
    public double calculateMaintenanceIndex(String sourceCode) {
        ...
        double value = 171 - 5.2 * Math.log(halsteadMetrics.getVolume()) - 0.23 * (mcCabeValue) - 16.2 * Math.log(slocValue);
        value = (float) (171 - (5.2 * Math.log(halsteadMetrics.getVolume())) - (0.23 * mcCabeValue) - (16.2 * Math.log(slocValue)));
        DecimalFormat decimalFormat = new DecimalFormat("##.00");
